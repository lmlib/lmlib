...
See also:
`lmlib.statespace.model.Alssm.trajectory`,
`lmlib.statespace.model.Alssm.trajectories`
...
plt.xlabel(r'Evaluation index $j$')
plt.ylabel(r'$s_j(x_0)$')
plt.title(r'Polynomial ALSSM Evaluation $s_j(x_0)$')
plt.legend()
plt.show()
