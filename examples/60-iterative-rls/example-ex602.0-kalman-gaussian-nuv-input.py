"""
Kalman Smoother with Gaussian and NUV Input [ex602.0]
=====================================================
...
.. container:: twocol
    ...
    .. container:: col-fig
       ...
       .. image:: ./do-not-remove/../../../../../_static/gallery/example-ex502.0-kalman-nuv-input.png   
          :width: 400
...
for ii in range(0,I_MAX):
    ...
    for k in range(1,K):
       ...
       # "AX+B1@U1=AX_" Node
       mF_AX_[k] = mF_AX[k] + B1@mF_U1[k] # II.1, III.1
       VF_AX_[k] = VF_AX[k] + B1@VF_U1[k]@BT  # II.2, III.2
       
       # "AX_+B2@U2=AX__" Node
       mF_AX__[k] = mF_AX_[k] + B2@mF_U2[k] # II.1, III.1
       VF_AX__[k] = VF_AX_[k] + B2@VF_U2[k]@B2T  # II.2, III.2
