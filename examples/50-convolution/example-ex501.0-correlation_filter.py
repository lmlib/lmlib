...
Correlation a lower dimensonal space is in many cases faster than the direct correlation in the high-dimensional sample space. 
...
print("Duration of correlation (or convolution) in ALSSM feature space (w/o mapping time): {:10.3f}ms".format((time.process_time()-start)*1e3))
...
print("Duration of correlation (or convolution) in sample space.                        : {:10.3f}ms".format((time.process_time()-start)*1e3))
