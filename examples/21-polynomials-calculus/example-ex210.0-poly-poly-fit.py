...
This example is derived and published in [\[Wildhaber2020\]](../../../bibliography.md#wildhaber2020).
...
# Segment (Exponential Window starting at a and ends at b, the decay is given by g (area), direction defines the
